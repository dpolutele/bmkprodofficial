          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="relative mb-6">
              ...
              <div
                ...
                style={{
                  backgroundImage: `url('https://cdn.builder.io/api/v1/image/assets%2F46a794b730c8481da05ae892b76aae02%2F98bd8b11b62d466b9898deb39b00afac?format=webp&width=800')`,
                  backgroundSize: "contain",
                  backgroundRepeat: "no-repeat",
                  backgroundPosition: "center",
                }}
              />
              <h1 className="relative text-4xl sm:text-6xl lg:text-7xl font-bold leading-tight">
            ...
            <p className="text-sm text-muted-foreground mb-12 max-w-xl mx-auto">
              Découvrez les sons avant-gardistes d'une nouvelle génération. Des
              beats purs, de l'énergie pure, de la passion pure.
            </p>
