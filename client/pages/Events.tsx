        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">
              Nos Événements et Albums
            </h1>
            <p className="text-lg text-muted-foreground mb-4">
              Cette page arrive bientôt. Continuez à me demander pour qu'elle
              soit remplie avec des galeries d'événements et des albums photo
              dans une disposition en mosaïque.
            </p>
            <p className="text-sm text-muted-foreground mb-8">
              Demandez-moi de créer une galerie de style Instagram avec des
              événements triables, des albums photo et une gestion dynamique du
              contenu.
            </p>
            <Link
              to="/"
